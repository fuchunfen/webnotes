 ...
 **/
 ...
 $.fn.extend({
	tabControl: function(options, tags) {
		...
		_tags = _tags.length > opts.maxTabCount ? _tags.slice(0, opts.maxTabCount - 1) : _tags;//超过最大标签数就截断
		...
		var compTab = function(obj, inputObj, value,id) {
			...
			var _span = "<span name='tab' id='radius' value='" + id + "'><b>" + value + "</b><a id='deltab'>×</a></span>";
